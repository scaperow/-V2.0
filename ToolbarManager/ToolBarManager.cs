...
namespace DockManager
{
	public class ToolBarManager : IMessageFilter
	{
        ...
        {
            return AddControl(c, site, VisualStyles.None, null, DockStyle.Right);
        }

        public ToolBarDockHolder AddControl(Control c)
        {
            return AddControl(c, DockStyle.Top, VisualStyles.None, null, DockStyle.Right);
        }

        public ToolBarDockHolder AddControl(Control c, DockStyle site, Control refControl, DockStyle refSite)
        {
            return AddControl(c, site, VisualStyles.None, refControl, refSite);
        }

        public ToolBarDockHolder AddControl(Control c, DockStyle site, VisualStyles cStyle) 
		{
			return AddControl(c, site,cStyle, null, DockStyle.Right);
		}
