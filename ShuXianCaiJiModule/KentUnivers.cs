...
{
    public class KentUnivers:MachineBase
    {
        ...
        public KentUnivers(bool isTest)
        {
            if (isTest)
            {
                log.WriteLog("isTest=true", false, false);
        ...
        void _SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            {
                log.WriteLog(ex.ToString() + System.Environment.NewLine + ex.StackTrace, false, false);
