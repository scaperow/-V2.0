...
{
    public class WHUnivers : MachineBase
    {
        /// <summary>
        /// 串口对象
        /// </summary>
        ...
        void _SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                //_StringBuilder.Append(_SerialPort.ReadExisting());


                //byte[] bytes = new byte[_SerialPort.BytesToRead];
                //_SerialPort.Read(bytes, 0, bytes.Length);

                //_StringBuilder.Append(System.Text.Encoding.Default.GetString(bytes, 0, bytes.Length));
                //if (Module.SpecialSetting.IsDebug)
                //{
                //    log.WriteLog("_StringBuilder" + _StringBuilder.ToString(), false, false);
                //}
