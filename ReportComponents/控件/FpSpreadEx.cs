...
{
    public partial class FpSpreadEx : FpSpread
    {
        ...
        internal float PaperWidth
        {
            get
            {
                ...
                {
                    int InnerWidth = ActiveSheet.PrintInfo.PaperSize.Height - ActiveSheet.PrintInfo.Margin.Left - ActiveSheet.PrintInfo.Margin.Right - ActiveSheet.PrintInfo.HeaderHeight - ActiveSheet.PrintInfo.FooterHeight;
        ...
        object KeyInputObj = new object();
        public delegate void KeyInput(Keys keyData);
        public event KeyInput KeyInputed
        {
            add
            {
                this.Events.AddHandler(KeyInputObj, value);
            }
            remove
            {
                this.Events.RemoveHandler(KeyInputObj, value);
            }
        }

        void OnKeyInput(Keys keyData)
        {
            KeyInput k = (KeyInput)this.Events[KeyInputObj];
            if (k != null)
            {
                k(keyData);
            }
