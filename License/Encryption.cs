...
{ 
    ...
    { 
        ...
        /// Instantiates a new symmetric encryption object using the specified provider. 
        /// </summary> 
        public Symmetric(Provider provider) : this(provider,true)
        {
        }
    ...
    { 
        ...
        { 
            string s = (string)ConfigurationSettings.AppSettings[key];
            if (s == null) { 
                if (isRequired) { 
        ...
        { 
            return WriteXmlNode(element,true);
        }
    } 
} 
