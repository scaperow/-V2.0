...
namespace WeifenLuo.WinFormsUI.Docking
{
	public class DockContent : Form, IDockContent
	{
		public DockContent()
		{
            ...
            m_dockHandler.Form.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.DockContent_FormClosed);
            m_dockHandler.Form.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.DockContent_FormClosing);
        ...
        {
            DockPanel.OnContentClosed(sender, e);
        }
