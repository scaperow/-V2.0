...
using Yqun.Client.Controls.Tab.Helpers;
...
namespace Yqun.Client.Controls.Tab
{
    public class FATabStripItemCollection : CollectionWithEvents
    {
        ...
        private SmartTabControl owner = null;
        ...
        public FATabStripItemCollection(SmartTabControl owner)
        {
            this.owner = owner;
            this.lockUpdate = 0;
        }
        ...
        public FATabStripItem this[int index]
        {
            ...
            set
            {
                List[index] = (FATabStripItem)value;
            }
        }
