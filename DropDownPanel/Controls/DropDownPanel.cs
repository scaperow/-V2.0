...
namespace AT.STO.UI.Win
{
	...
	#region Public Properties
        ...
        public bool DroppedDown
        {
            get
            {
                return combo.DroppedDown;
            }
            set
            {
                combo.DroppedDown = value;
            }
        }
	...
	#region IDropDownAware Implementation
        ...
        static object DropDownClosedObject = new object();
        public event EventHandler DropDownClosed
        {
            add
            {
                Events.AddHandler(DropDownClosedObject, value);
            }
            remove
            {
                Events.RemoveHandler(DropDownClosedObject, value);
            }
        }

        private void OnDropDownClosed(EventArgs e)
        {
            EventHandler h = Events[DropDownClosedObject] as EventHandler;
            if (h != null)
            {
                h(this, e);
            }
